...
import 'package:flutter_merakli/view/settings/notification_view.dart';
import 'package:flutter_merakli/view/settings/account_settings_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      ...
      body: Column(children: [
        ...
        Column(
          children: [
            ...items.map((item) => _infoTileWidget(item, context)).toList(),
            const SizedBox(
              height: 55,
            ),
            _dividerLineWidget(context)
